...
describe('rangeSlider', function () {
  ...
  describe('widget usage', function () {
    ...
    beforeEach(function () {
      ...
      }, 'indexName', { disjunctiveFacets: ['aNummAttr'] });
    });
    ...
    describe('with results', function () {
      ...
      it('calls the refinement function if refined with min+1', function () {
        ...
        expect(state1).toEqual(state0.addNumericRefinement(attributeName, '>=', targetValue));
      });
      ...
      it('calls the refinement function if refined with min+1 and max-1', function () {
        ...
        expect(helper.search).toHaveBeenCalledTimes(1);
        expect(state1).toEqual(state0.addNumericRefinement(attributeName, '>=', targetValue[0]).addNumericRefinement(attributeName, '<=', targetValue[1]));
      });
    });
  });
});