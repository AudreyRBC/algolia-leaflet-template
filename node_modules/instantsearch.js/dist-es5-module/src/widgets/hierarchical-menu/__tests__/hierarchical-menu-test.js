...
describe('hierarchicalMenu()', function () {
  ...
  describe('getConfiguration', function () {
    ...
    it('understand the showParentLevel option', function () {
      expect((0, _hierarchicalMenu2.default)(_extends({ showParentLevel: false }, options)).getConfiguration({})).toEqual({
        hierarchicalFacets: [{
          name: 'hello',
          rootPath: null,
          attributes: ['hello', 'world'],
    ...
    describe('limit option', function () {
      ...
      it('uses provided maxValuesPerFacet when higher', function () {
        return expect((0, _hierarchicalMenu2.default)(_extends({ limit: 20 }, options)).getConfiguration({ maxValuesPerFacet: 30 }).maxValuesPerFacet).toBe(30);
      });

      it('ignores provided maxValuesPerFacet when lower', function () {
        return expect((0, _hierarchicalMenu2.default)(_extends({ limit: 10 }, options)).getConfiguration({ maxValuesPerFacet: 3 }).maxValuesPerFacet).toBe(10);
      });
    });
  });
  ...
  describe('render', function () {
    ...
    it('has a limit option', function () {
      ...
      var expectedFacetValues = [{ label: 'one', value: 'one' }, { label: 'two', value: 'two', data: [{ label: 'six', value: 'six' }, { label: 'seven', value: 'seven' }, { label: 'eight', value: 'eight' }] }, { label: 'three', value: 'three' }];
