...
describe('currentToggle()', function () {
  describe('good usage', function () {
    ...
    beforeEach(function () {
      ...
      _toggle2.default.__Rewire__('ReactDOM', ReactDOM);
      ...
      widget = (0, _toggle2.default)({ container: containerNode, attributeName: attributeName, label: label });
    ...
    describe('render', function () {
      ...
      it('calls twice ReactDOM.render', function () {
        ...
        widget = (0, _toggle2.default)({ container: containerNode, attributeName: attributeName, label: label, userValues: userValues });
    ...
    describe('refine', function () {
      ...
      describe('specific values', function () {
        it('toggle on should change the refined value', function () {
          ...
          widget = (0, _toggle2.default)({ container: containerNode, attributeName: attributeName, label: label, values: userValues });
          widget.getConfiguration();
    ...
    afterEach(function () {
      _toggle2.default.__ResetDependency__('ReactDOM');
    });
  });
});