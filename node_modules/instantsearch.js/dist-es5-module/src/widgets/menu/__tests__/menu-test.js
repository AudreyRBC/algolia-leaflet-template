...
describe('menu', function () {
  ...
  it('snapshot', function () {
    ...
    _menu2.default.__Rewire__('ReactDOM', ReactDOM);
    var widget = (0, _menu2.default)({ container: document.createElement('div'), attributeName: 'test' });
    ...
    _menu2.default.__ResetDependency__('ReactDOM');
  });
});