...
var _defaultTemplates = require('../../../widgets/star-rating/defaultTemplates.js');
...
describe('starRating()', function () {
  ...
  beforeEach(function () {
    ...
    widget.init({ helper: helper, instantSearchInstance: { templatesConfig: undefined } });
  });
  ...
  it('calls twice ReactDOM.render(<RefinementList props />, container)', function () {
    ...
    var props = {
      ...
      facetValues: [{
        ...
        count: 0, name: '4', value: '4', labels: _defaultLabels2.default
      }, {
        isRefined: false, stars: [true, true, true, false, false],
        count: 0, name: '3', value: '3', labels: _defaultLabels2.default
      }, {
        isRefined: false, stars: [true, true, false, false, false],
        count: 0, name: '2', value: '2', labels: _defaultLabels2.default
      }, {
        isRefined: false, stars: [true, false, false, false, false],
        count: 0, name: '1', value: '1', labels: _defaultLabels2.default
      }],
