...
describe('numericRefinementList()', function () {
  ...
  it('calls twice ReactDOM.render(<RefinementList props />, container)', function () {
    ...
    var props = {
      ...
      facetValues: [{ label: 'All', value: encodeValue(), isRefined: true }, { label: 'less than 4', value: encodeValue(undefined, 4), isRefined: false }, { label: '4', value: encodeValue(4, 4), isRefined: false }, { label: 'between 5 and 10', value: encodeValue(5, 10), isRefined: false }, { label: 'more than 10', value: encodeValue(10), isRefined: false }],
