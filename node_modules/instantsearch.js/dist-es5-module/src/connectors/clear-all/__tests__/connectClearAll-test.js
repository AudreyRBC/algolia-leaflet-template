...
describe('connectClearAll', function () {
  ...
  it('Receives a mean to clear the values', function () {
    ...
    var helper = (0, _algoliasearchHelper2.default)({ addAlgoliaAgent: function addAlgoliaAgent() {} }, '', { facets: ['myFacet'] });
    helper.search = _sinon2.default.stub();
  ...
  it('some refinements from results <=> hasRefinements = true', function () {
    ...
    var helper = (0, _algoliasearchHelper2.default)({ addAlgoliaAgent: function addAlgoliaAgent() {} }, undefined, { facets: ['aFacet'] });
