...
var mapOptionsToItems = function mapOptionsToItems(_ref) {
  var start = _ref.start,
      ...
      label = _ref.name;
  return { label: label, value: encodeValue(start, end), isRefined: false };
};
...
describe('connectNumericRefinementList', function () {
  ...
  it('provides the correct facet values', function () {
    ...
    var firstRenderingOptions = rendering.lastCall.args[0];
    expect(firstRenderingOptions.items).toEqual([{ label: 'below 10', value: encodeValue(undefined, 10), isRefined: false }, { label: '10 - 20', value: encodeValue(10, 20), isRefined: false }, { label: 'more than 20', value: encodeValue(20), isRefined: false }]);
    ...
    var secondRenderingOptions = rendering.lastCall.args[0];
    expect(secondRenderingOptions.items).toEqual([{ label: 'below 10', value: encodeValue(undefined, 10), isRefined: false }, { label: '10 - 20', value: encodeValue(10, 20), isRefined: false }, { label: 'more than 20', value: encodeValue(20), isRefined: false }]);
  });
