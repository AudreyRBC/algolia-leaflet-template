...
describe('PriceRangesForm', function () {
  ...
  describe('submit', function () {
    it('starts a refine on submit', function () {
      ...
      _testUtils2.default.Simulate.change(component.refs.from);
      component.refs.to.value = 20;
      _testUtils2.default.Simulate.change(component.refs.to);
      _testUtils2.default.Simulate.submit(component.refs.form);
